...
INSERT INTO SpotifyClone.albums (artist_id, album, year_album)
VALUES
 (1, 'Envious', 1990),
 (1, 'Exuberant', 1993),
...
INSERT INTO SpotifyClone.songs (song, duration, album_id)
VALUES
  ("Soul For Us", 200, 1),
...
INSERT INTO SpotifyClone.planos(plan, price)
VALUES
('gratuito',0),
('universitario',5.99),
('pessoal',6.99),
...
VALUES
  ...
  CREATE TABLE SpotifyClone.playback(
    ...
    FOREIGN KEY (song_id) REFERENCES SpotifyClone.cancoes(song_id),
    CONSTRAINT PRIMARY KEY (user_id, song_id)
) engine = InnoDB;

INSERT INTO SpotifyClone.playback (user_id, song_id, reproduction_date)
VALUES
